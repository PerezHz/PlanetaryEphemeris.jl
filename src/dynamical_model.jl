...
@taylorize function DE430!(dq, q, params, t)
            ...
            if i == j
                ...
                if UJ_interaction[i,j]
                    ...
                    if j == mo
                        ...
                        temp_N_M_x[i] = N_MfigM_x + N_MfigM_pmA_x[i]
                        N_MfigM_x = temp_N_M_x[i]
                        temp_N_M_y[i] = N_MfigM_y + N_MfigM_pmA_y[i]
                        N_MfigM_y = temp_N_M_y[i]
                        temp_N_M_z[i] = N_MfigM_z + N_MfigM_pmA_z[i]
                        N_MfigM_z = temp_N_M_z[i]
                    end
                end
            end # else (i != j)
        end
    ...
    # dq[6N+4] = inv_I_m_t[1,1]*N_MfigM_x + inv_I_m_t[1,2]*N_MfigM_y + inv_I_m_t[1,3]*N_MfigM_z
    # dq[6N+5] = inv_I_m_t[2,1]*N_MfigM_x + inv_I_m_t[2,2]*N_MfigM_y + inv_I_m_t[2,3]*N_MfigM_z
    # dq[6N+6] = inv_I_m_t[3,1]*N_MfigM_x + inv_I_m_t[3,2]*N_MfigM_y + inv_I_m_t[3,3]*N_MfigM_z
