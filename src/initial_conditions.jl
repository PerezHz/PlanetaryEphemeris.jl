...
For the initial conditions at 1969-Jun-28.0 see Table 5 and 6 in page 47 (Sun + Planets + Moon positions and velocities), Table 7 in page 49 (lunar mantle and core libration angles/rates) and Table 13 in pages 60-74 (positions and velocities) of https://ui.adsabs.harvard.edu/abs/2014IPNPR.196C...1F%2F/abstract.
"""
function initialcond(N, jd0::Float64=datetime2julian(DateTime(1969,6,28,0,0,0)))
    ...
    if dt0 == dt0_1969
        ...
        ss_ic_filename = "ss11ic_1969Jun28.txt"     # Planets (+ Sun & Moon) initial conditiosn file
