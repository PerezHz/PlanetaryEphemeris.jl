function initialcond(N)
    ...
    smppic = readdlm( joinpath(dirname(pathof(PlanetaryEphemeris)), "ss11ic.txt") ) # "ss11ic_1969Jun28.txt"
    for i in 1:11
    ...
    ast343ic = readdlm( joinpath(dirname(pathof(PlanetaryEphemeris)), "ast343ic.txt") ) # "ast343ic_1969Jun28.txt"
    for i in 12:N
        ith_body_ind = nbodyind(N, i)
